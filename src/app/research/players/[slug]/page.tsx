...
const getTeamData = async ( {slug}: any) => {
    const team = `http://localhost:3000/api/research/player/${slug}` 
...
const Team = async( {params}: any) => {
    ...
    return (
        ...
        //                 <Link href={`/research/teams/${data.Key}/roster#teamInfoRoster`} className="bg-lime-500 rounded-full p-2 lg:p-3 hover:border hover:border-lime-500 hover:text-lime-500 hover:bg-white hover:underline">Roster</Link>
        //                 <Link href={`/research/teams/${data.Key}/schedule#teamInfoSchedule`} className="bg-lime-500 rounded-full p-2 lg:p-3 hover:border hover:border-lime-500 hover:text-lime-500 hover:bg-white hover:underline">Schedule</Link>
        //             </div>
