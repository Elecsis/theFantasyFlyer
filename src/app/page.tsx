  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-white text-black  xl:px-20">
     ...
     <div className='w-full px-10'>
        <h1 className='font-bold text-3xl text-center md:text-5xl lg:text-6xl lg:pt-14'>We Fly High and Hunt Fantasy Football Championships</h1>
     ...
     <div className=' flex flex-col sm:flex-row pt-16 w-screen md:pr-10 lg:px-10'>
        ...
        <div className='flex flex-col justify-center pt-10 sm:w-1/2 px-10 '>
     ...
     <div className='w-full lg:px-10'>
      ...
      <div className='grid grid-cols-1 gap-4 w-full  sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 px-10 lg:px-0'>
          <Link href={"/news"} className=" md:w-full bg-lime-500 hover:bg-lime-900 p-2 rounded-md text-white text-center">News</Link>
          <Link href={"/news"} className="w-full bg-sky-500 hover:bg-sky-900 p-2 rounded-md text-white text-center">Blog</Link>
          <Link href={"/news"} className="w-full bg-rose-500 hover:bg-rose-900 p-2 rounded-md text-white text-center">Mock</Link>
          <Link href={"/news"} className="w-full bg-amber-500 hover:bg-amber-900 p-2 rounded-md text-white text-center">Fantasy</Link>
          <Link href={"/news"} className="w-full bg-emerald-500 hover:bg-emerald-900 p-2 rounded-md text-white text-center">Conference</Link>
          <Link href={"/news"} className="w-full bg-cyan-500 hover:bg-cyan-900 p-2 rounded-md text-white text-center">Division</Link>
          <Link href={"/news"} className="w-full bg-fuchsia-500 hover:bg-fuchsia-900 p-2 rounded-md text-white text-center">Team</Link>
          <Link href={"/news"} className="w-full bg-stone-500 hover:bg-stone-900 p-2 rounded-md text-white text-center">Player</Link>
      </div>
     </div>
