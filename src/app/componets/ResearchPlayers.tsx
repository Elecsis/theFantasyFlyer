    ...
    return (
        <div className='flex flex-col w-full bg-white gap-5 px-8' >
            ...
            {data[0]?.map((player: any)=>(
                <Link href={`/research/players/${player.Name}?player=${player.Name}`} className="flex flex-row w-full border border-lime-500 rounded-full items-center justify-evenly pl-5 drop-shadow-lg " key={player.PlayerID} id="topList">
